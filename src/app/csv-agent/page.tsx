      ...
      <div className="max-w-3xl mx-auto">
        ...
        {summary && (
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100">
            <h2 className="text-sm font-bold uppercase tracking-widest text-slate-400 mb-4">Agent Summary</h2>
            ...
            <div className="flex gap-2 border-t pt-6">
              <input 
                type="text" 
                placeholder="Ask a specific question about this data..."
                className="flex-1 bg-white border border-slate-200 rounded-lg px-4 py-2 outline-none focus:ring-2 focus:ring-blue-500"
                value={question}
